...
# The output_schema is now automatically detected from the type annotation!
# No need for: get_weather_info.output_schema = WeatherInfo.model_json_schema()

if __name__ == "__main__":
    # Let's first see what the auto-generated schema looks like
    print("=== Auto-generated Output Schema ===")
    import json
    ...
    # Create agent WITHOUT the structured outputs parameter
    # Tool output schemas should still work fine
    agent = CodeAgent(
